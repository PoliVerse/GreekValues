    ...
    return (
        <div className='parties d-flex flex-column justify-content-center align-items-center gap-4'>
            ...
            <Stack className='parties-category' gap={5}>
                ...
                <Party party='ΜέΡΑ25' color='#EB4326' description='Αριστερό, διεθνιστικό κόμμα που ιδρύθηκε το 2018. Υποστηρίζει προοδευτική κοινωνική πολιτική και ισχυρό κράτος πρόνοιας. Προσελκύει ψηφοφόρους παρόμοιους με αυτούς του ΣΥΡΙΖΑ.' img='img-35' logo={MeRA25} percentage23='2,50%' percentage24='2,54%' poll='2-3' />
